...
import { ShoppingCart, Star, MapPin, ArrowRight, Instagram, MessageSquare, Store, Newspaper } from 'lucide-react';
...
export default function Home() {
  ...
  const homeBanners = React.useMemo(() => {
    ...
    const main = settings?.heroImageUrl;
    const all = b.length > 0 ? b : (main ? [main] : ["https://images.unsplash.com/photo-1544025162-d76694265947?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80"]);
    return all;
  }, [settings]);
  ...
  const unitsLeft = Math.max(2, productionLimit - 15);
    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <AnimatePresence mode="wait">
            <motion.img 
              ...
              src={homeBanners[currentBannerIndex]} 
              alt="Delicious Pie" 
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-brand-orange rounded-full text-sm font-bold shadow-lg">
            ...
            {homeBanners.map((_, i) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  i === currentBannerIndex ? 'bg-brand-orange w-8' : 'bg-white/40'
                }`}
              />
            ))}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/loja" className="text-brand-orange font-bold flex items-center gap-2">
            ...
            <Link to="/loja" key={product.id} className="card group">
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <div className="p-3 bg-brand-brown text-white rounded-xl group-hover:bg-brand-orange transition-colors">
                    <ShoppingCart size={20} />
                  </div>
                </div>
              </div>
      ...
      {/* Social Proof */}
      <section className="bg-brand-brown text-white py-20 overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4 pt-12">
               <div className="aspect-[3/4] bg-brand-orange rounded-3xl overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1519340241574-2dec39624824?auto=format&fit=crop&w=400&q=80" alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" loading="lazy" />
               </div>
               <div className="aspect-square bg-brand-beige rounded-3xl overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=400&q=80" alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" loading="lazy" />
               </div>
            </div>
            <div className="space-y-4">
               <div className="aspect-square bg-brand-beige rounded-3xl overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=400&q=80" alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" loading="lazy" />
               </div>
               <div className="aspect-[3/4] bg-brand-orange rounded-3xl overflow-hidden shadow-2xl">
                <img src="https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=400&q=80" alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" loading="lazy" />
               </div>
            </div>
          </div>
        </div>
